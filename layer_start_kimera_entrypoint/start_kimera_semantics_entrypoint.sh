...
cp /tmp/kimera-semantics-Input_Output/kimera_semantics_demo.bag /root/catkin_ws/src/Kimera-Semantics/kimera_semantics_ros/rosbags/
...
cp /root/catkin_ws/src/Kimera-Semantics/kimera_semantics_ros/mesh_results/*.ply /tmp/kimera-semantics-Input_Output/
